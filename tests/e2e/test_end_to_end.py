...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "institute",
            {'CMCC', 'MRI', 'LASG-CESS', 'BNU', 'MPI-M', 'NCAR', 'NIMR-KMA', 'LASG-IAP', 'IPSL', 'NASA-GISS'},
        ),
        (
            "model",
            {'FGOALS-g2', 'FGOALS-gl', 'IPSL-CM5A-LR', 'GISS-E2-R', 'FGOALS-s2', 'IPSL-CM5B-LR', 'GISS-E2-R-CC', 'GISS-E2-H', 'IPSL-CM5A-MR', 'GISS-E2-H-CC'},
        ),
        (
            "realm",
            {
        ...
        (
            "experiment",
            {'rcp60', 'past1000', 'decadal1975', 'piControl', 'amip', 'sstClimSulfate', 'sstClim', 'rcp85', 'historical', 'rcp45'},
        ),
        (
            "frequency",
        ...
        (
            "table",
            {'Amon', 'cfDay', '6hrLev', 'Omon', 'OImon', 'cfMon', 'Lmon', 'day', '3hr', '6hrPlev'},
        ),
        (
            "ensemble",
            {'r3i1p4', 'r2i1p1', 'r1i1p4', 'r1i1p1', 'r4i1p1', 'r2i1p6', 'r7i1p1', 'r2i1p2', 'r10i1p1', 'r3i1p1'},
        ),
        (
            "version",
            {'v20161204', 'v20120430', 'v20111119', 'v20130506', 'v2', 'v20110901', 'v1', 'v4', 'v20110726', 'v20120804'},
        ),
        (
            "variable",
        ...
        (
            "time_range",
            {'20640101-20641231', '19080101-19081231', '20490101-20491231', '19270101-19271231', '000101-003012', '20360101-20361231', '204501010000-204512311800', '19550101-19551231', '100001-119912', '19220101-19221231'},
        ),
    ],
)
