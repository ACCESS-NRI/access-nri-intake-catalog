...
class TestMOPPyPlugin:
    ...
    def test_plugin_enables_without_access_moppy(self):
        ...
        from access_nri_intake.plugins.moppy import enable_moppy_plugin, disable_moppy_plugin
    ...
    def test_moppy_availability_check(self):
        ...
        from access_nri_intake.plugins.moppy import is_moppy_available, enable_moppy_plugin, disable_moppy_plugin
