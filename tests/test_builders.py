...
@pytest.mark.parametrize(
    ...
    [
        ...
        (["access-esm1-5"], "AccessEsm15Builder", {}, 11, 11, 10),
        ...
        (["access-am3"], "AccessAm3Builder", {}, 4, 4, 2),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "atmos",
            None,
            "atmos.1day.bnds:2.lat:2.lat_v:2.lon:2.lon_u:2.soil_model_level_number:2",
        ),
        (
            ...
            "ocean",
            None,
            "ocean.1mon.nv:2.xt_ocean:2.yt_ocean:2",
        ),
        (
        ...
        (
            ...
            "ocean",
            "r10i1p1f1",
            "ocean.fx.xt_ocean:2.yt_ocean:2",
        ),
        (
            "access-esm1-6/historical-historical-1.1-r10i1p1f1-aaca3142/historical-historical-1.1-r10i1p1f1-aaca3142/output001/ocean/ocean-2d-roughness_amp.nc",
            "AccessEsm16Builder",
        ...
        (
            ...
            "atmos",
            None,
            "atmos.1day.bnds:2.depth:2.lat:2.lat_v:2.lon:2.lon_u:2.model_rho_level_number:2.model_theta_level_number:2.pseudo_level:2",
        ),
        (
        ...
        (
            "online_mlt/025deg_jra55_iaf_cycle6_online_mlt/output335/ice/OUTPUT/iceh.1988-01-01.nc",
            "OnlineMltBuilder",
            "seaIce",
            None,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            builders.AccessAm3Builder,
            "am3a.pm1982jan_nodata.nc",
            "time",
            "bnds:2.depth:6.dim0:8.height:40.height_0:40.lat:144.lat_v:145.lon:192.lon_u:192.model_rho_level_number:85.model_theta_level_number:85.model_theta_level_number_0:50.model_theta_level_number_2:52.pressure_0:7.pressure_1:17.pseudo_level:6.pseudo_level_0:7.pseudo_level_1:15.pseudo_level_2:17.pseudo_level_3:13",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # The AM3 output filenames do not explicitly encode freq info in the
    ...
    [
        ...
        (
            ...
            _NCFileInfo(
                ...
                file_id="bnds:2.depth:2.lat:2.lat_v:2.lon:2.lon_u:2.model_rho_level_number:2.model_theta_level_number:2.pseudo_level:2",
                frequency="1day",
                start_date="1982-01-01, 00:00:00",
                end_date="1982-01-03, 00:00:00",
                variable=[
                    "depth",
                    "depth_bnds",
                    "fld_s00i407",
                ...
                variable_long_name=[
                    ...
                    "Stable boundary layer indicator",
                    ...
                    "10 METRE NEUTRAL WIND U-COMP B GRID",
                    "10 METRE NEUTRAL WIND V-COMP B GRID",
                    "10 METRE NEUTRAL WIND SPEED B GRID",
                    "10 METRE NEUTRAL WIND SPEED B GRID",
                    "mid level convection indicator",
