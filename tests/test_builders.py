...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "mopper/ashwed83/v1-0/1hr/huss/huss_AUS2200_ashwed1983_1hr_198302150030-198302172330.nc",
            "MopperBuilder",
            "unknown",
            None,
        ...
        (
            "mopper/ashwed83/v1-0/1hr/tas/tas_AUS2200_ashwed1983_1hr_198302150030-198302172330.nc",
            "MopperBuilder",
            "unknown",
            None,
        ...
        (
            "mopper/ashwed83/v1-0/10min/cllow/cllow_AUS2200_ashwed1983_subhrPt_19830216001000-19830217000000.nc",
            "MopperBuilder",
            "unknown",
            None,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            builders.AccessOm2Builder,
            "iceh.1958-02-daily",
            ("iceh_XXXX_XX_daily", "1958-02", (1, "day"), {"ts": "1958-02"}),
        ),
        (
            builders.AccessOm2Builder,
            "iceh.1985-08-31",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "mopper/ashwed83/v1-0/1hr/huss/huss_AUS2200_ashwed1983_1hr_198302150030-198302172330.nc",
            _NCFileInfo(
                filename="huss_AUS2200_ashwed1983_1hr_198302150030-198302172330.nc",
                file_id="v1_0/1hr/huss/huss_AUS2200_ashwed1983_1hr_XXXXXXXXXXXX_XXXXXXXXXXXX",
                path=None,  # type: ignore
                filename_timestamp="198302150030-198302172330",
                frequency="1hr",
                start_date="1983-02-15, 00:00:00",
                end_date="1983-02-18, 00:00:00",
                variable=["time", "lon", "lat", "height", "huss"],
                variable_long_name=[
                    "time",
                    "Longitude",
                    "Latitude",
                ...
                variable_cell_methods=["", "", "", "", "area: mean time: mean"],
                variable_units=[
                    "days since 1970-01-01",
                    "degrees_east",
                    "degrees_north",
        ...
        (
            ...
            "mopper/ashwed83/v1-0/1hr/tas/tas_AUS2200_ashwed1983_1hr_198302150030-198302172330.nc",
            _NCFileInfo(
                filename="tas_AUS2200_ashwed1983_1hr_198302150030-198302172330.nc",
                file_id="v1_0/1hr/tas/tas_AUS2200_ashwed1983_1hr_XXXXXXXXXXXX_XXXXXXXXXXXX",
                path=None,  # type: ignore
                filename_timestamp="198302150030-198302172330",
                frequency="1hr",
                start_date="1983-02-15, 00:00:00",
                end_date="1983-02-18, 00:00:00",
                variable=["time", "lon", "lat", "height", "tas"],
                variable_long_name=[
                    "time",
                    "Longitude",
                    "Latitude",
