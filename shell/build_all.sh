...
CATALOG_NAME=/g/data/tm70/ds0092/projects/nri_intake_catalog/dfcatalog.csv

configs=( access-om2.yaml ) #cmip5.yaml cmip6.yaml access-om2.yaml access-cm2.yaml access-esm1-5.yaml )
