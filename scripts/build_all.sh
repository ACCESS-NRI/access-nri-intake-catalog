...
CATALOG_NAME=/g/data/tm70/ds0092/data/tmp/dfcatalog.csv

configs=( access-om2.yaml ) # cmip5.yaml erai.yaml

for config in "${configs[@]}"; do
    metacat-build --catalog_name=${CATALOG_NAME} ${CONFIG_DIR}/$config $PBS_NCPUS
done
