...
def to_cmip(
    self,
    xarray_open_kwargs: dict[str, Any] | None = None,
    cmor_table: str | None = None,
...
def enable_moppy_plugin() -> bool:
    ...
    try:
        ...
        warnings.warn(
            "intake-esm is not available. MOPPy plugin cannot be enabled.", UserWarning
        )
        return False
    ...
    if MOPPY_AVAILABLE:
        ...
        print(
            "✓ MOPPy plugin enabled (ACCESS-MOPPy not available - install for full functionality)"
        )
