...
* The notebook on `building intake-esm catalogs` demonstrates how to build your own intake-esm catalog for data from an experiment you have just run (for example).
